...
export const ChainWhitelist: React.FC<ChainWhitelistProps> = ({
  ...
  const [localWhitelist, setLocalWhitelist] = useState<{ [chainId: string]: boolean }>(whitelist);

  const handleToggleChain = (chainId: string) => {
    const newWhitelist = { ...localWhitelist, [chainId]: !localWhitelist[chainId] };
