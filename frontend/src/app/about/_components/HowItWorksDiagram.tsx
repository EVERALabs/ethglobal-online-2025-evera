          ...
          <div className="max-w-5xl mx-auto">
            ...
            <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-12">
              ...
              <div className="text-center">
                ...
                <h3 className="text-lg font-bold text-primary mb-2">1. Monitor</h3>
              ...
              <div className="text-center">
                ...
                <h3 className="text-lg font-bold text-secondary mb-2">2. Analyze</h3>
                <p className="text-sm text-black">
              ...
              <div className="text-center">
                ...
                <h3 className="text-lg font-bold text-accent mb-2">3. Execute</h3>
                <p className="text-sm text-black">
            ...
            <div className="text-center">
              ...
              <h3 className="text-lg font-bold text-success mb-2">4. Optimize</h3>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        <div className="card bg-white shadow-xl border border-gray-200">
          <div className="card-body p-6 text-center">
            ...
            <h3 className="text-xl font-bold text-primary mb-3">Gas Optimization</h3>
        ...
        <div className="card bg-white shadow-xl border border-gray-200">
          <div className="card-body p-6 text-center">
            ...
            <h3 className="text-xl font-bold text-secondary mb-3">Yield Maximization</h3>
            <p className="text-black">
        ...
        <div className="card bg-white shadow-xl border border-gray-200">
          <div className="card-body p-6 text-center">
            ...
            <h3 className="text-xl font-bold text-accent mb-3">Risk Management</h3>
            <p className="text-black">
